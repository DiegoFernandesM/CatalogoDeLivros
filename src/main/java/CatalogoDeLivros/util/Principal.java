package CatalogoDeLivros.util;

import CatalogoDeLivros.Model.Autor;
import CatalogoDeLivros.Model.Livro;
import CatalogoDeLivros.Model.DadosLivros;
import CatalogoDeLivros.Service.ConsumoApi;
import CatalogoDeLivros.Service.ConverteDados;
import CatalogoDeLivros.repository.LivroRepository;
...
public class Principal {
    ...
    private void buscarLivrosPeloTitulo() {
        ...
        try {
            ...
            System.out.println("https://gutendex.com/books?search= " + endereco);
           ...
           // System.out.println("Resposta da API: " + jsonResponse);
            ...
            List<DadosLivros> livrosDTO = converteDados.getObjectMapper()
            ...
            if (!livrosDTO.isEmpty()) {
                ...
                for (DadosLivros livro : livrosDTO) {
